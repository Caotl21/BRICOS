...
#define FifoSize 200   // ����3��fifo��С �ֽ���
typedef struct // ���� Fifo������
{
    U8 RxBuf[FifoSize];
    volatile U8 In;
...
// =================================��ֲ�ӿ�======================================
    ...
    extern F32 AccX,AccY,AccZ, Accabs; // ������
    extern F32 GyroX,GyroY,GyroZ, Gyroabs; // 陀螺仪
    extern F32 MagX,MagY,MagZ, Magabs; // 磁力计

    extern U8 isNewData_im948;// 1=�������µ����ݵ�ȫ�ֱ�������
