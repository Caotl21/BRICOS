...
F32 AngleX_im948,AngleY_im948,AngleZ_im948=0;// 从Cmd_RxUnpack中获取到的欧拉角数据更新到全局变量以便用户自己的业务逻辑使用, 若还需要其它数据，可参考进行增加即可
F32 AccX_im948,AccY_im948,AccZ_im948, Accabs_im948=0; // 加速度
F32 GyroX_im948,GyroY_im948,GyroZ_im948, Gyroabs_im948=0; // 陀螺仪
F32 W_quat_im948, X_quat_im948, Y_quat_im948, Z_quat_im948=0;  // 四元数
F32 Temp_im948, Press_im948=0;  // 温度、压力

U8 IM948_GetNewData=0;// 1=更新了新的数据到全局变量里了
/**
